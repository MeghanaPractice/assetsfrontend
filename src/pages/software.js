            ...
            <Container className='containerStyle'>
                <Paper elevation={3} className='paperStyle2'>
                    <div className='div-spaceToSides'>
                        <Typography variant="h1" sx={{display:'inline-flex',alignItems:'center'}}><img width="25" height="25" src="https://img.icons8.com/ios/50/laptop-settings--v2.png" alt="laptop-settings--v2"/>  Software</Typography>
                        <div className='div-rightstyle'>
                            <TableHelpModal />
                            {userRole == 'Admin' &&
                                <><SoftwareImport /><SoftwareAdd setRefreshTable={setRefreshTable}></SoftwareAdd></>
                            }</div>
                    </div>
