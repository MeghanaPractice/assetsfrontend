            ...
            <Container className='containerStyle'>
                <Paper elevation={3} className='paperStyle2'>
                    <div className='div-spaceToSides'>
                        <Typography variant="h1" sx={{display:'inline-flex',alignItems:'center'}}><img width="25" height="25" src='./hardwarelogo.png'/>  Hardware</Typography>
                        <div className='div-rightstyle'>
                            <TableHelpModal />
                            {userRole == 'Admin' &&
                                <><HardwareImport /><HardwareAdd setRefreshTable={setRefreshTable}></HardwareAdd></>
                            }</div>
                    </div>
